...
```typescript
import { ChatClient, fetchServerSentEvents, clientTools } from "@tanstack/ai-client";
...
```typescript
import { createChatClientOptions, clientTools, InferChatMessages } from "@tanstack/ai-client";
