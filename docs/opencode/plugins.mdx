...
- `$`: Bun's [shell API](https://bun.com./runtime/shell) for executing commands.
...
Levels: `debug`, `info`, `warn`, `error`. See [SDK documentation](https://opencode.ai./sdk) for details.
