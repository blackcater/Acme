...
| clang-format         | .c, .cpp, .h, .hpp, .ino, and [more](https://clang.llvm.org./ClangFormat.html)                       | `.clang-format` config file                                                                           |
...
| prettier             | .js, .jsx, .ts, .tsx, .html, .css, .md, .json, .yaml, and [more](https://prettier.io./en/index.html) | `prettier` dependency in `package.json`                                                               |
