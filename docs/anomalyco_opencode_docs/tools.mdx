...
By default, all tools are **enabled** and don't need permission to run. You can control tool behavior through [permissions](./permissions).
...
[Learn more](./permissions) about configuring permissions.
