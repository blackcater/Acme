...
:::note
Prefer unique names unless you intentionally want to replace a built-in tool. If you want to disable a built in tool but not override it, use [permissions](./permissions).
:::
...
Here we are using the [`Bun.$`](https://bun.com./runtime/shell) utility to run the Python script.
