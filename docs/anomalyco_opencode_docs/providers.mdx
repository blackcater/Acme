...
:::tip
The `global` region improves availability and reduces errors at no extra cost. Use regional endpoints (e.g., `us-central1`) for data residency requirements. [Learn more](https://cloud.google.com/vertex-ai/generative-ai./partner-models/use-partner-models#regional_and_global_endpoints)
:::
...
[Hugging Face Inference Providers](https://huggingface.co./inference-providers) provides access to open models supported by 17+ providers.
...
To use [Scaleway Generative APIs](https://www.scaleway.com/en./generative-apis/) with Opencode:
