...
- [apps/electron/resources/release-notes/0.4.5.md](apps/electron/resources/release-notes/0.4.5.md)
...
For information about platform-specific build configurations and cross-compilation, see [Platform-Specific Builds](#6.1). For details on the auto-update mechanism and update distribution, see [Self-Update System](#6.3).
...
├── Craft-Agent-x64.dmg
├── Craft-Agent-arm64.zip          # For electron-updater delta updates
├── Craft-Agent-x64.zip
└── mac-arm64/
    └── Craft Agents.app
```
...
- **afterPack** - Executes after application files are packed
...
**Sources:** [apps/electron/package.json:37-40]()
